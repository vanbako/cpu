...
- `docs/implementation/release-regression-capture.md`: I33-S02 full release regression capture gate for RC checklist evidence, local checks, fast/slow/all Verilator suites, FPGA validators, reproducible-build metadata, command logs, and blocker disposition.
- `docs/implementation/release-traceability-audit.md`: I33-S03 release traceability audit gate for conformance-index ownership, E15 coverage, conformance/litmus tests, RTL gate rows, evidence notes, stale references, and deferred future stories.
- `docs/implementation/single-core-v0.1-known-limitations.md`: I33-S04 known-limitations and errata freeze for unsupported features, board blockers, deferred multicore/fabric work, DDR/cacheable/tag policy, release scope, and follow-up handoff.
- `docs/implementation/release-candidate-bundle.md`: I33-S05 reproducible release-candidate bundle gate for commit, tool versions, generated images, bitstream hashes, reports, evidence archives, docs, and rerun commands.
