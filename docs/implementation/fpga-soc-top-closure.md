...
| `uart_pin_mux_missing` | I30-S03 adds `uart_rx_i` and the firmware/status UART TX combine. | `I30-S03` | `rtl/cpu_v01_fpga_top_soc_peripherals_tb.sv` | `python tools\fpga_soc_top_peripherals.py --check` | I30-S05 UART smoke, I30-S06 closure archive, and I30-S04 loader arbitration. |
