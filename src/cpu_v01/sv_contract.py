...
def _constants() -> tuple[SvConstant, ...]:
    return (
        ...
        _const("CACHE_MAINT_KIND_BITS", 2, 8, ("cache_maintenance",), "Cache-maintenance selector width."),
        ...
        _const("CACHE_MAINT_NONE", 0, 2, ("cache_maintenance",), "No cache-maintenance effect."),
        _const("CACHE_MAINT_CLEAN", 1, 2, ("cache_maintenance",), "Clean data/tag cache lines."),
        _const("CACHE_MAINT_INVAL", 2, 2, ("cache_maintenance",), "Invalidate data/tag cache lines."),
        _const("CACHE_MAINT_CLEANINVAL", 3, 2, ("cache_maintenance",), "Clean and invalidate data/tag cache lines."),
    ...
    return (
        ...
        SvStruct(
            ...
            (
                ...
                _field("capability_write_valid", "logic", 1, ("retire_packets", "capabilities", "tags"), "Capability write effect is valid."),
                _field("capability_write_index", "logic", 3, ("retire_packets", "capabilities"), "Capability destination register index."),
                _field("capability_write_value", "cap_t", None, ("retire_packets", "capabilities", "tags"), "Capability write payload and tag."),
                _field("csr_write_valid", "logic", 1, ("retire_packets", "csrs"), "Scalar CSR write effect is valid."),
                _field("csr_write_index", "logic", csrs.CSR_NUMBER_BITS, ("retire_packets", "csrs"), "Scalar CSR destination number."),
                _field("csr_write_value", "logic", state.INTEGER_REGISTER_BITS, ("retire_packets", "csrs", "cells"), "Scalar CSR write value."),
                _field("ccsr_write_valid", "logic", 1, ("retire_packets", "csrs", "capabilities", "tags"), "Capability CSR write effect is valid."),
                _field("ccsr_write_index", "logic", 8, ("retire_packets", "csrs"), "Capability CSR destination index."),
                _field("ccsr_write_value", "cap_t", None, ("retire_packets", "csrs", "capabilities", "tags"), "Capability CSR write payload and tag."),
                _field("memory_effect_kind", "logic", 2, ("retire_packets", "data_memory", "tag_memory"), "Selected memory effect kind."),
                _field("memory_effect_address", "logic", cells.ADDRESS_BITS, ("retire_packets", "data_memory", "tag_memory", "cells"), "Memory effect cell address."),
                _field("memory_integer_value", "logic", state.INTEGER_REGISTER_BITS, ("retire_packets", "data_memory", "cells"), "ST48 payload value."),
                _field("memory_capability_value", "cap_t", None, ("retire_packets", "data_memory", "tag_memory", "capabilities", "tags"), "CSC payload and tag value."),
                _field("tag_write_valid", "logic", 1, ("retire_packets", "tag_memory", "tags"), "Memory tag write effect is valid."),
                _field("tag_write_value", "logic", caps.CAPABILITY_TAG_BITS, ("retire_packets", "tag_memory", "tags"), "Memory tag write value."),
                _field("pcc_update_valid", "logic", 1, ("retire_packets", "capabilities", "tags"), "PCC update effect is valid."),
                _field("pcc_update_value", "cap_t", None, ("retire_packets", "capabilities", "tags"), "PCC update payload and tag."),
                _field("pcc_update_slot", "logic", 1, ("retire_packets",), "PCC hidden slot update."),
                _field("epcc_update_valid", "logic", 1, ("retire_packets", "capabilities", "tags"), "EPCC update effect is valid."),
                _field("epcc_update_value", "cap_t", None, ("retire_packets", "capabilities", "tags"), "EPCC update payload and tag."),
                _field("epcc_update_slot", "logic", 1, ("retire_packets",), "EPCC hidden slot update."),
                ...
                _field("reservation_install_valid", "logic", 1, ("retire_packets", "reservations"), "LL48 installs a reservation."),
                _field("reservation_clear_valid", "logic", 1, ("retire_packets", "reservations"), "Reservation clear effect is valid."),
                _field("reservation_word_address", "logic", cells.ADDRESS_BITS, ("retire_packets", "reservations", "cells"), "Reserved aligned physical word address."),
                _field("reservation_memory_type", "logic", 2, ("retire_packets", "reservations", "mmu"), "Memory type associated with the reservation."),
                _field("sc_success", "logic", 1, ("retire_packets", "reservations"), "SC48 success result before integer result encoding."),
                _field("fence_order_valid", "logic", 1, ("retire_packets", "ordering"), "FENCE ordering effect is valid."),
                _field("fence_i_valid", "logic", 1, ("retire_packets", "ordering"), "FENCE.I instruction-side ordering effect is valid."),
                _field("cache_maintenance_valid", "logic", 1, ("retire_packets", "cache_maintenance"), "Cache-maintenance effect is valid."),
                _field("cache_maintenance_kind", "logic", 2, ("retire_packets", "cache_maintenance"), "Cache-maintenance operation selector."),
                _field("cache_maintenance_address", "logic", cells.ADDRESS_BITS, ("retire_packets", "cache_maintenance", "cells"), "First maintained physical cache-line address."),
                _field("cache_maintenance_length", "logic", cells.ADDRESS_BITS, ("retire_packets", "cache_maintenance", "cells"), "Maintained range length in cells."),
            ),
        ),
    )
